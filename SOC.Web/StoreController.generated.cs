...
namespace SOC.Web.Controllers {
    public partial class StoreController {
        ...
        public class ActionNamesClass {
            public readonly string OrderForm = "OrderForm";
        }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_StoreController: SOC.Web.Controllers.StoreController {
        public T4MVC_StoreController() : base(Dummy.Instance) { }

        public override System.Web.Mvc.ActionResult OrderForm() {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.OrderForm);
            return callInfo;
        }
